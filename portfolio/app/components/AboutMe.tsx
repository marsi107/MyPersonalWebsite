...
const AboutMe = () => {
    return (
        <div id="AboutMe">
            ...
            <Tilt className="max-w-6xl shadow-lg bg-black bg-opacity-5 border-l-2 dark:bg-opacity-20 p-6 border-l-defColors-main dark:border-l-[1px]">
                <img src="../resources/images/profile.png" alt="profile image about Ruben" className="float-left mr-6 mb-1 w-32 rounded-full" />
